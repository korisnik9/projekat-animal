...
function addItem(productName, productDescription, productImage, productPrice) {
    ...
    if (productImage) { newImg.src = productImage } else { newImg.src = "SAT.png" }
...
function showModalWindow1(e) {
    ...
    modal.innerHTML += "<p>" + main.children[1].innerText + "</p>";
    if (main.children[2].src) { var imgsrc = main.children[2].src; } else { imgsrc = "SAT.png"; }
    modal.innerHTML += "<img src=\"" + imgsrc + "\"/>";
    modal.innerHTML += "<p>" + main.children[4].innerText + "<br>"+ " Opis: " + main.children[3].innerText + "</p>";
...
function addToChart(e) {
    ...
    if (arrOfBoughtWatches.indexOf(main.children[0].innerText.toLowerCase()) === -1) {
        ...
        divInPI.innerHTML += "<h3>" + main.children[1].innerText + "</h3>";
        divInPI.innerHTML += "<p>" + main.children[4].innerText + " &times;" + "<span class=\"times\">" + " 1" + "</span>" + "</p>"
        productInfo.appendChild(divInPI);
        productInfo.innerHTML += "<img src=\"" + main.children[2].src + "\"/>"
        ...
        var watchPrice = main.children[4].innerText;
...
function showModalWindow(e) {
    ...
    var container = document.getElementsByClassName("container")[0];
    var modal = document.getElementsByClassName("modalwindow")[0];
    modal.innerHTML += "<h2> Cestitamo </h2>";
